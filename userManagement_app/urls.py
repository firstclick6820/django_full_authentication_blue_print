...
from .views import UserLogin, userRegister, userLogout, userVerifyEmail, user_password_reset
...
urlpatterns = [
    ...
    path('reset/done/', auth_views.PasswordResetCompleteView.as_view(template_name='userManagement_app/Auth/password/password_reset_complete.html'), name='password_reset_complete'),   
]
